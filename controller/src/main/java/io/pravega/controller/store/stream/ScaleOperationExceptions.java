...
public class ScaleOperationExceptions {
    ...
    public static class ScaleInvalidException extends ScaleOperationException {
    }
    ...
    public static class ScaleRequestDisabledException extends ScaleOperationException {
    }
}
